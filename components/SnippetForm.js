    ...
    return (
        ...
        <form onSubmit={handleSubmit(snippet ? updateSnippet : createSnippet)}>
            <div className="mb-4">
                ...
                />
                {errors.name && (
                    <p className="font-bold text-yellow-300">Name is required</p>
                )}
            </div>
            <div className="mb-4">
                <label
                ...
                >
                {errors.language && (
                    <p className="font-bold text-yellow-300">Language is required</p>
                )}
            ...
            <div className="mb-4">
                ...
                ></textarea>
                {errors.description && (
                    <p className="font-bold text-yellow-300">Description is required</p>
                )}
            </div>
            <div className="mb-4">
                <label
                ...
                ></textarea>
                {errors.code && (
                    <p className="font-bold text-yellow-300">Code is required</p>
                )}
            </div>
            <button
            ...
            <Link href="/">
                <a className="mt-3 inline-block bg-teal-800 hover:bg-teal-900 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                    Cancel
                </a>
            </Link>
        </form>
